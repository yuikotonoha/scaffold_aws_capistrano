...
set :application, "scaffold_aws_capistrano"
set :repo_url, "git@github.com:yuikotonoha/scaffold_aws_capistrano.git"
set :user, 'kotonoha'
set :deploy_to, "/var/www/scaffold_aws_capistrano"
